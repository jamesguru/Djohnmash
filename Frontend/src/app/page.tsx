  ...
  return (
    <div className="font-sans">
      ...
      <section className="h-screen bg-cover bg-center bg-no-repeat relative">
        ...
        {/* Logo */}
        <div className="absolute top-4 left-4 sm:top-8 sm:left-10 z-[999]">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center text-center px-4 sm:px-6 z-10">
          <h1 className="hidden sm:block text-3xl sm:text-4xl text-[#C8A560] md:text-5xl font-bold text-white mb-4">
            Relax, Rejuvenate, Revitalize
          </h1>
          <p className="hidden sm:block text-base sm:text-lg text-[#C8A560] md:text-xl text-gray-300 mb-6">
            Experience the best massage in town
          </p>
          {/* Horizontal Booking Card */}
          <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 flex flex-wrap justify-between items-center space-y-4 md:space-y-0">
            <div className="w-full md:flex-1 md:mr-4">
              <label className="block text-left text-gray-800 font-semibold mb-2">Full Name</label>
              <input
                type="text"
            ...
            <div className="w-full md:flex-1 md:mr-4">
              <label className="block text-left text-gray-800 font-semibold mb-2">Phone</label>
              <input
                type="text"
            ...
            <div className="w-full md:flex-1 md:mr-4">
              <label className="block text-left text-gray-800 font-semibold mb-2">Email</label>
              <input
                type="email"
            ...
            <div className="w-full md:flex-1 md:mr-4">
              <label className="block text-left text-gray-800 font-semibold mb-2">Service</label>
              <input
                type="text"
            ...
            <div className="w-full md:flex-1 md:mr-4">
              <label className="block text-left text-gray-800 font-semibold mb-2">Preferred Date</label>
              <input
                type="date"
                required
            ...
            <button
              className="w-full md:w-auto bg-[#121212] text-[#C8A560] font-semibold px-6 py-3 rounded-lg shadow-lg hover:text-[#D4AF37] transition duration-300"
  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-left">
      ...
      <div className="mb-8 sm:mb-0">
        ...
        <ul className="text-gray-400">
          <li className="mb-2">Address: 123 Relaxation St, City, Country</li>
          <li className="mb-2">Phone: <a href="tel:254757939067" className="hover:text-[#D4AF37]">254 757 939 067</a></li>
          <li className="mb-2">Email: <a href="mailto:info@massageparlor.com" className="hover:text-[#D4AF37]">info@massageparlor.com</a></li>
        </ul>
      </div>
